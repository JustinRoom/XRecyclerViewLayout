...
import org.jsc.xrecyclerviewlayout.progressindicator.AVLoadingIndicatorView;
	...
	public void setState(int state) {
		...
		switch(state){
            case STATE_NORMAL:
                ...
                mStatusTextView.setText(R.string.header_hint_pull);
                break;
            ...
            case     STATE_REFRESHING:
                mStatusTextView.setText(R.string.header_hint_refreshing);
                break;
            case    STATE_DONE:
                mStatusTextView.setText(R.string.header_hint_refresh_done);
                break;
            default:
		}
